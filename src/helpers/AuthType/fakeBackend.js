...
// import { d } from "helpers/fakebackend_helper"
...
const fakeBackend = () => {
  ...
  mock.onGet(url.GET_TECHNOLOGY).reply(() => {
    console.log("mock")
  ...
  // mock.onPost("http://localhost:5000/api/technology").reply(user => {
  //   return new Promise((resolve, reject) => {
  //     setTimeout(() => {
  //       if (user && user.data) {
  //         // Passing fake JSON data as response
