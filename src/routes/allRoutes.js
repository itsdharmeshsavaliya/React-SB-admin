...
import Technologyview from "../pages/Technology/View"

//Careerform
import Careerform from "../pages/CareerForm/Careerform"
import Careerformview from "../pages/CareerForm/View"
...
import Futureview from "../pages/Future/View"

//Portfolio
import Portfoliocategory from "../pages/Portfolio/Portfoliocategory"
import Portfoliocategoryview from "../pages/Portfolio/View"

//Telentfaq
import Talentfaq from "../pages/Talentfaq/Talentfaq"
import Talentfaqview from "../pages/Talentfaq/View"
...
const userRoutes = [
  ...
  {path: "/technology/add",component:Technology},
  {path: "/technology/:id",component:Technology},

  //Careerform
  {path:"/careerform",component:Careerformview},
  {path:"/careerform/add",component:Careerform},
  {path:"/careerform/:id",component:Careerform},

  //Career
  {path:"/career",component:Careerview},
  {path:"/career/add",component:Career},
  {path:"/career/:id",component:Career},


  //Future
  {path:"/future",component:Futureview},
  {path:"/future/add",component:Future},
  {path:"/future/:id",component:Future},

  //Portfolio
  {path:"/portfoliocategory",component:Portfoliocategoryview},
  {path:"/portfoliocategory/add",component:Portfoliocategory},

  //Telentfaq
  {path:"/talentfaq",component:Talentfaqview},
  {path:"/talentfaq/add",component:Talentfaq},
  {path:"/talentfaq/:id",component:Talentfaq}
