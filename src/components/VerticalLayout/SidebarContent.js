      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
            <Link to="/careerform" className="">
                <i className="bx bx-file"></i>
                <span>{props.t("Careerform")}</span>
              </Link>
            </li>
            ...
            <li>
            <Link to="/future" className="">
                <i className="bx bx-file"></i>
                <span>{props.t("Future")}</span>
              </Link>
            </li>

            <li>
            <Link to="/portfoliocategory" className="">
                <i className="bx bx-file"></i>
            ...
            <li>
            <Link to="/talentfaq" className="">
                <i className="bx bx-file"></i>
                <span>{props.t("Talentfaq")}</span>
              </Link>
            </li>
